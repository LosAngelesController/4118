...
Longitude: {lng} | Latitude: {lat} | Zoom: {zoom}
        ...
        <div className=' outsideTitle max-h-screen flex-col flex z-50'>
          <div className='titleBox max-h-screen mt-2 ml-2 md:mt-3 md:ml-3 break-words'>41.18 By-Resolution Areas</div>
          <div className={`geocoder md:hidden`} id='geocoder'></div>
          {
          ...
          <div className='flex flex-col md:flex-row w-auto md:auto md:flex-nowrap '>
            {this.state.infoBoxShown && (
              <div className='flex-none font-sans mt-3 md:mt-3 p-2 banned-box-text ml-2 md:ml-3 bg-truegray-900 bg-opacity-90 md:bg-opacity-70 rounded-xl text-xs' style={{}}>
                <div className='md:max-w-xs  mt-1'>Banned: sit, lie, sleep, or store, use, maintain, or place personal property within:</div>
                <div className='md:max-w-xs mt-1 pt-3'>
                  <span className='font-mono h-1 w-1 bg-yellow-500 text-black rounded-full px-2 py-1 mr-2'>1000ft</span>
                  <span className='font-xs'> </span>Facility providing shelter, safe sleeping, safe parking, or serving as a homeless services navigation center
                </div>
                <div className='md:max-w-xs  mt-1 pt-3'>
                  <span className='font-mono h-1 w-1 bg-red-600 rounded-full px-2 py-1 mr-2'>500ft</span>Other locations (school, park, tunnel, underpass, bridge, active railway, etc.)
                </div>
                {
                  this.state.pendinglegend === true && (
                    <div className='md:max-w-xs flex flex-row mt-1'>
            ...
            </div>
            {
              featuresTotal.features.map((eachFeature: any, eachFeatureIndex: any) => (
                <div className=' bg-truegray-800 my-2 px-2 py-1 rounded-sm ' key={eachFeatureIndex} onClick={(event) => {
                  ...
                  {/* This paragraph has pther paragraphs nested inside. Can't do this */}
        ...
        <div ref={this.mapContainer} style={{}} className="map-container" />
        <DisclaimerPopup
        ...
        {this.state.isPopupActive && (
          <div className={`text-xs absolute bottom-3 left-3 md:right-4 md:left-auto md:bottom-9 w-auto text-white z-10 popupbox z-auto  rounded-sm bg-opacity-75`}>
